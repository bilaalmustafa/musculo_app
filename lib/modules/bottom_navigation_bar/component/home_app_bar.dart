    ...
    return StreamBuilder<UserModel?>(
      ...
      builder: (context, snapshot) {
        ...
        return AppBar(
          ...
          elevation: 0,
          automaticallyImplyLeading: false,
          backgroundColor: !isCreator ? ConstColors.white : ConstColors.black,
          title: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              PoppinsText(
              ...
              if (snapshot.connectionState == ConnectionState.waiting)
                ...
                PoppinsText(
                  ...
                  fontSize: Sizes.s20,
                  color: isCreator ? ConstColors.white : ConstColors.black,
                  fontWeight: TextWeight.semiBold,
                ),
            ],
          ),
          actions: [
            ...
            IconButton(
              ...
              icon: SharePicture(
                ...
                height: Sizes.s24,
                colorFilter: ColorFilter.mode(
                  isCreator ? ConstColors.white : ConstColors.black,
                  BlendMode.srcIn,
                ),
              ),
            ),
