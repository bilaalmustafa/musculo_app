...
class BecomecreatorScreen extends StatefulWidget {
  final bool fromUpgradePopup;
  const BecomecreatorScreen({super.key, this.fromUpgradePopup = false});
...
class _BecomecreatorScreenState extends State<BecomecreatorScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final subPlan = data?.subPlane ?? "";
    return PopScope(
      canPop: false,
      onPopInvokedWithResult: (didPop, result) {
        if (!didPop) {
          if (widget.fromUpgradePopup) {
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            children: [
                              ...
                              PlanListTile(
                                text: 'UNLIMITED workouts to create',
                              ),
                              PlanListTile(
                                text: 'UNLIMITED programs to create',
                              ),
